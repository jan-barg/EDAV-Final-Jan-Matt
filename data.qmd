...
The data collection was done using API calls to the FRED and World Bank databases, using a python script, available [here](../data-gathering/datafetch.ipynb). The script created master-wide and master-long datasets, which will be used as the backbone of this project.
